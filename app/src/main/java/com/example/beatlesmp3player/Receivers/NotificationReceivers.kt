   ...
   private fun play_btn_function(){
    ...
    private fun prevNext_btn(increment: Boolean, context: Context){
        ...
        if (PlayerActivity.isfav){
            PlayerActivity.binding.playerToolbar.searchBtn.setImageResource(R.drawable.ic_favorite)
        }
        else PlayerActivity.binding.playerToolbar.searchBtn.setImageResource(R.drawable.ic_favorite_empty)
